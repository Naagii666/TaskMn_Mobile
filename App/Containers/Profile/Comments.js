...
// import { getProfile, onAddComment } from './ProfileActions'
import { getAllWorkers ,getWorkerComments , onAddComment } from '../Search/WorkersActions'
...
class Comments extends React.Component {
    ...
    render() {
        const { comments2 , loading2 } = this.props;
        const { navigation } = this.props;
        const UserID = navigation.getParam('UserID', null);
        return(
...
export default connect(
    state => ({
      ...
      loading2: state.workers.getIn(['comment_list', 'loading']),
      comments2: state.workers.getIn(['comment_list', 'data']),
